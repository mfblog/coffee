...
const StageDivider: React.FC<StageDividerProps> = ({ stageNumber }) => {
    return (
        <div className="my-7 relative">
            ...
            {/* 阶段标识 - 调整垂直对齐 */}
            <div className="absolute top-[-1px] left-1/2 transform -translate-x-1/2 translate-y-[-50%] bg-neutral-50 dark:bg-neutral-900 px-3 inline-flex items-center justify-center">
