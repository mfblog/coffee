...
咖啡冲泡指南是一款现代化的咖啡冲泡助手应用，帮助咖啡爱好者记录、追踪和优化他们的冲泡过程。本应用作为一个全面的解决方案，支持多种冲泡器具、方法，并提供详细的冲泡记录功能。
...
| 平台 | 技术 | 特性 |
|------|------|------|
| Web | PWA | 离线支持、可安装、响应式设计 |
| iOS | Capacitor | 原生 UI 集成、相机访问、本地存储 |
| Android | Capacitor | 原生 UI 集成、相机访问、本地存储 |

## 核心功能

### 冲泡流程管理

- 🧰 **多种冲泡器具支持**：V60、聪明杯、Kalita、Origami 等
- 📋 **丰富的冲泡方案库**：预设和自定义的冲泡方法
- ⏱️ **精确的冲泡计时器**：按阶段引导冲泡过程
...
- 📉 **消耗追踪**：记录使用情况和查看剩余数量
- 🔍 **豆子搜索**：实时过滤查找豆子
- 🎲 **随机豆子选择**：通过视觉突出显示随机选择用于冲泡的豆子

### 冲泡笔记

- ✍️ **详细的冲泡记录**：记录每次冲泡的评分、口感属性和笔记
